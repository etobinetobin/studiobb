...
(function (a) {
    CogzidelDashboard = {
        ...
        initSpinner: function () {
            var b = new Image();
            b.src = base_url+"images/spinner.gif";
            a(".edit_room_nav").delegate("a", "click", function () {
                a(".edit_room_nav .spinner").removeClass("spinner");
                a(this).find(".icon").addClass("spinner")
            })
        ...
        this.each(function (e, f) {
            ...
            g.hover(function (h) {
                if (!b) {
                    b = a("#tooltip");
                    if (!b.length) {
                        b = a('<p id="tooltip"></p>').appendTo("body")
                    }
                }
                var i = g.attr("title");
                g.data("tooltip-title", i);
                g.attr("title", null);
                b.html(i.replace(/\n/g, "<br />")).css("top", (h.pageY - c) + "px").css("left", (h.pageX + d) + "px").fadeIn("fast")
            }, function () {
                g.attr("title", g.data("tooltip-title"));
                g.data("tooltip-title", null);
                b.hide()
            });
            g.mousemove(function (h) {
                a("#tooltip").css("top", (h.pageY - c) + "px").css("left", (h.pageX + d) + "px")
            })
        });
        return this
    }
