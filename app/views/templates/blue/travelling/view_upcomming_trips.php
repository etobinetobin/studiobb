...
<div id="dashboard_container">
    <div class="Box" id="View_Upcome_Trips">
        <div class="Box_Head msgbg"><h2><?php echo translate("Upcoming Trips"); ?><span class="View_MyPrint"> <a href="javascript:void(0);" onclick="javascript:print_reservation();"><?php echo translate("Print this page"); ?></a> </span></h2></div>
...
<tr>
         <td> <p class="View_my_Accept_Bg"><span><?php echo $row->name; ?></span></p> </td>
            ...
            <td  width="20%"><?php echo get_user_times($row->checkin, get_user_timezone()).' - '.get_user_times($row->checkout, get_user_timezone()); ?></td>
         <td>
