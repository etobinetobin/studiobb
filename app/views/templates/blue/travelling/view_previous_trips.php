...
<tr>
         <td  width="18%"> <p class="View_my_Accept_Bg"><span><?php echo $row->name; ?></span></p> </td>
            ...
            <td width="27%">
             ...
             <p><a class="clsLink2_Bg" href="<?php echo site_url('trips/send_message/'.$row->userby); ?>"><?php echo translate("View").' / '.translate("Send").' '.translate("Message"); ?></a></p>
            </td>
            <td><?php echo get_user_times($row->checkout, get_user_timezone()).' - '.get_user_times($row->checkout, get_user_timezone()); ?></td>
         <td>
