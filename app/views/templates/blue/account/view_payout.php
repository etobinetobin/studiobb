...
<div id="dashboard_container">
  <div class="Box" id="View_Payout">
    ...
    <div class="Box_Content">
      ...
      <div style="" id="payout_new_initial"> <a class="clsLink2_Bg" onclick="$('#payout_new_initial').hide();$('#payout_country_select').show();$('#change_default').hide();return false;" href="javascript:void(0);"><?php echo translate("Add Payout Method"); ?></a>&nbsp;&nbsp;&nbsp;<a class="clsLink2_Bg" onclick="$('#change_default_show_link').hide();$('#change_default').show();$('#change_default_hide_link').show();return(false);" href="javascript:void(0);" id="change_default_show_link"><?php echo translate("Change Default"); ?></a> <a class="clsLink2_Bg" style="display:none;" onclick="$('#change_default_hide_link').hide();$('#change_default_show_link').show();$('#change_default').hide();return(false);" href="javascript:void(0);" id="change_default_hide_link"><?php echo translate("Don't Change Default"); ?></a> </div>
      <!--Payment Method-->
