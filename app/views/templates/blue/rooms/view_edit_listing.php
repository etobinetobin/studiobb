...
<?php //echo  strip_tags(str_replace('[removed]', '', $row->desc));
//echo str_replace('^nl;^',"\n",$row->desc);
echo $row->desc;
 ?>
                        	 </textarea>
                ...
                <ul id="details">
                  ...
                  <li>
                    ...
                    <select class="fixed-width" id="hosting_bedrooms" name="bedrooms">
                      ...
                      <?php for($i = 1; $i <= 10; $i++) { ?>
                      <option value="<?php echo $i; ?>"><?php echo $i; ?> <?php echo translate("bedroom");if($i > 1) echo 's'; ?>
                      </option>
                      <?php } ?>
                    </select>
                  ...
                  <li>
                    ...
                    <select class="fixed-width" id="hosting_beds" name="beds">
                      <?php for($i = 1; $i <= 16; $i++) { ?>
                      <option value="<?php echo $i; ?>"><?php echo $i; if($i == 16) echo '+'; ?> <?php echo translate("bed"); ?><?php if($i > 1) echo 's';?></option>
                      <?php } ?>
                    </select>
                  ...
                  <li class="clearfix">
                    ...
                    <select name="cancellation_policy" id="cancellation_policy" class="fixed-width">
	                  <option value="Flexible"<?php if($row->cancellation_policy == "Flexible"){echo "selected";} ?>>Flexible</option>
	                  <option value="Moderate" <?php if($row->cancellation_policy == "Moderate"){echo "selected";} ?>>Moderate</option>
	                  <option value="Strict"<?php if($row->cancellation_policy == "Strict"){echo "selected";} ?>>Strict</option>
	                  <option value="Super Strict"<?php if($row->cancellation_policy == "Super Strict"){echo "selected";} ?>>Super Strict</option>
	                  <option value="Long Term"<?php if($row->cancellation_policy == "Long Term"){echo "selected";} ?>>Long Term</option> 
                    </select>
                  </li>
                </ul>
                <div class="clear"></div>
        ...
        data-message-contact="<strong>We just can't seem to find you.</strong><br />If you continue to have problems, please <a href='<?php echo site_url('pages/contact'); ?>'>contact support</a> to change your address."></span> </h2>
              ...
              <div class="map-view">
                <h3 class="map-description exact"> <span class="protip">
																 <a onclick="show1();add();" id="edit-address" href="#" style="display: inline;"><?php echo translate("Edit address"); ?></a> 
